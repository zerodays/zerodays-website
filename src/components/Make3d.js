...
import bcgImage from '../res/img/projects/make3d_background.jpg';
import make3dImage from '../res/img/projects/make3d.svg';
...
class Make3d extends Component {
  ...
  render() {
    ...
    return <div className={classes.root}>
      <div className={classes.abs} style={{
        background: `linear-gradient(rgba(20, 20, 20, 0.75), rgba(20, 20, 20, 0.75)) center center / cover, url("${bcgImage}")`,
      ...
      <Grid container direction='column' justify='center' className={classes.abs}>
        <Grid item>
          <Grid container direction='row' justify='center'>
            <Grid item xs={5}>
              <img src={make3dImage} alt='make3d logo' className={classes.w100}/>
            </Grid>
          </Grid>
        </Grid>
      </Grid>
...
export default withStyles(styles)(Make3d);