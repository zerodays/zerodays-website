...
const strings = new LocalizedStrings({
  en: {
    ...
    sistem404Description: <Fragment>
      ...
      collaborated with <a href='https://404.si'>Zavod 404</a> and built a fully integrated web app. In 2020 a
    ...
    otoDescription: <Fragment>
      We have developed a mobile app shipped together with the <a href='https://massageshagger.com/'>OTO Massage
    ...
    tampontrackDescription: <Fragment>
      <a href="https://www.tampontrack.com/">TamponTrack</a> mobile app for automated tracking of tampon usage in
      order
      to to ensure women's health and well-being.
    </Fragment>,
    wool2loopDescription: <Fragment>
      <a href="https://www.wool2loop.eu/en/">Wool2loop</a> web platform for submission and oversight of objects,
      3D
      printed using recycled mineral wool waste.
    </Fragment>,
    zascitimoSiDescription: <Fragment>
      <a href="https://akcija.zascitimo.si/">Zascitimo.si</a> coordination website for aid in distribution of
      resources
    ...
    dilaDescription: <Fragment>
      <a href='https://dilaboards.com/'>Dillaboards</a> - an online store for affordable electric skateboards.
    </Fragment>,

    sievaDescription: <Fragment>
      <a href="http://3dlab.sieva.si/">Sieva 3D lab</a> coordinates 3D printing on an industrial metal 3D printer. Users
