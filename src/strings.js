...
const strings = new LocalizedStrings({
  en: {
    ...
    zerodayDescription: (classes) => (
      <Fragment>
        <Typography className={clsx(classes.description, classes.textCenter, classes.textBlack)}>
          A <a href='https://en.wikipedia.org/wiki/Zero-day_(computing)' target='_blank' rel='noopener noreferrer'>zero-day</a> (also known as 0-day) vulnerability is a
    ...
    gremDescription: <Fragment>
      ...
      includes mobile app for <a  target='_blank' rel='noopener noreferrer' href="https://apps.apple.com/si/app/grem/id1276023527">iOS</a> and <a
    ...
    spectreDescription: <Fragment>
      ...
      with <a  target='_blank' rel='noopener noreferrer' href="https://spectrelabs.si/">Spectre Laboratories</a>. It allows for rapid prototyping of medical
    ...
    sistem404Description: <Fragment>
      ...
      collaborated with <a  target='_blank' rel='noopener noreferrer' href='https://404.si'>Zavod 404</a> and built a fully integrated web app. In 2020 a
    ...
    otoDescription: <Fragment>
      We have developed a mobile app shipped together with the <a  target='_blank' rel='noopener noreferrer' href='https://massageshagger.com/'>OTO Massage
    ...
    skozDescription: <Fragment>
      ...
      for high
      schools. It was developed under a national project in collaboration with <a  target='_blank' rel='noopener noreferrer' href='https://404.si'>Zavod
    ...
    make3dDescription: <Fragment>
      Make3D was developed for <a  target='_blank' rel='noopener noreferrer' href="https://404.si">Zavod 404</a> in order to connect 3D printing specialists with customers in a flawless and cost efficient
    ...
    olloDescription: <Fragment>
      Integration of <a  target='_blank' rel='noopener noreferrer' href="https://www.minimax.si/">Minimax</a> and <a  target='_blank' rel='noopener noreferrer' href="https://www.posta.si/">Post of
      Slovenia</a> APIs into the retail and distribution workflow of the <a  target='_blank' rel='noopener noreferrer' href="https://olloaudio.com/">Ollo
      Audio</a> company.
    </Fragment>,

    tampontrackDescription: <Fragment>
      <a  target='_blank' rel='noopener noreferrer' href="https://www.tampontrack.com/">TamponTrack</a> mobile app for automated tracking of tampon usage in
      order
      to to ensure women's health and well-being.
    </Fragment>,
    wool2loopDescription: <Fragment>
      <a  target='_blank' rel='noopener noreferrer' href="https://www.wool2loop.eu/en/">Wool2loop</a> web platform for submission and oversight of objects,
      3D
      printed using recycled mineral wool waste.
    </Fragment>,
    zascitimoSiDescription: <Fragment>
      <a  target='_blank' rel='noopener noreferrer' href="https://zascitimo.si/">Zascitimo.si</a> coordination website for aid in distribution of
      resources
    ...
    dilaDescription: <Fragment>
      <a  target='_blank' rel='noopener noreferrer' href='https://dilaboards.com/'>Dillaboards</a> - an online store for affordable electric skateboards.
    </Fragment>,

    sievaDescription: <Fragment>
      <a  target='_blank' rel='noopener noreferrer' href="http://3dlab.sieva.si/">Sieva 3D lab</a> coordinates 3D printing on an industrial metal 3D printer. Users
      can submit their orders, receive quotes and follow production progress.
    </Fragment>,
